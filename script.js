// Celý kód se spustí až ve chvíli, kdy je stránka 100% načtená včetně všech prvků
    ...
    document.getElementById("vypocitat").addEventListener("click", function() {
        ...
        mujGraf = new Chart(ctx, {
            ...
            options: { 
                ...
                animation: { duration: 800, easing: 'easeOutQuart' } // Plynulé rozbalení grafu
            }
        });
    });

    // Jednorázové automatické kliknutí HNED PO NAČTENÍ webu, aby graf rovnou naskočil
